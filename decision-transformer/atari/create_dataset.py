...
def create_dataset(num_buffers, num_steps, game, data_dir_prefix, trajectories_per_buffer):
    ...
    return obss, actions, returns, done_idxs, rtg, timesteps, num_trajectories


def create_dataset_rwds(num_buffers, num_steps, game, data_dir_prefix, trajectories_per_buffer):
    # -- load data from memory (make more efficient)
    obss = []
    actions = []
    returns = [0]
    ...
    return obss, actions, returns, done_idxs, rtg, timesteps, num_trajectories, stepwise_returns